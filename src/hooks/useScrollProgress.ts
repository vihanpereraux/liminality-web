...
interface ScrollProgressHookReturn {
...
export const useScrollProgress = ({ onTransitionComplete }: ScrollProgressHookProps = {}): ScrollProgressHookReturn => {
        ...
        const handleWheel = (e: WheelEvent) => {
            ...
            if (isAtBottom) {
                ...
                if (e.deltaY > 0 && !isProgressActive) {
                    ...
                    // Only activate progress mode after user has scrolled enough (400px worth)
                ...
                if (isProgressActive) {
                    ...
                    if (newProgress >= 100 && !hasLoggedBottom.current) {
                        ...
                        setTimeout(() => {
                            setShowCircularProgress(false);
                            setShowOverlay(true);
                            onTransitionComplete?.(); // Call optional callback
                        }, 500);
                    }
    ...
    }, [hasReachedBottom, showCircularProgress, showOverlay, onTransitionComplete]);
