...
import CircularScrollProgress from "../components/ui/circular-scroll-progress";
...
const Home: React.FC = () => {
    ...
    // Scroll to top on component mount and location changes
    useEffect(() => {
        window.scrollTo(0, 0);
    ...
    return (
        <>
            ...
            {/* transition */}
            <Transition
                chamberSection={getTransitionScreenText().screenOne.chamberSection}
                chamberTitle={getTransitionScreenText().screenOne.chamberTitle}
                textLines={getTransitionScreenText().screenOne.textLines}
                nextRoute={getTransitionScreenText().screenOne.nextRoute}
